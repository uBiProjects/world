/**
 * This file contains useful functions that are used throughout the
 * simulation.
 * It includes error handling, maths, and functions that differentiate 
...
// subtract 2 vectors return _c1-_c2
Coordinate subCoordinates(Coordinate _c1, Coordinate _c2) {

        return Coordinate((_c1.x - _c2.x), (_c1.y - _c2.y));
}

// compare equal 2 vectors return true / false
bool isEqualCoordinates(Coordinate _c1, Coordinate _c2) {
...
// compute lowest common multiple of a and b use => abs(a*b)=kgV*ggT
