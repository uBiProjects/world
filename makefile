...
ConsumerI.o: ConsumerI.cpp ConsumerI.h Life.h Creature.h Utils.h
	g++ -o ConsumerI.o -c ConsumerI.cpp -Wall -pedantic

ConsumerII.o: ConsumerII.cpp ConsumerII.h Life.h Creature.h Utils.h
	g++ -o ConsumerII.o -c ConsumerII.cpp -Wall -pedantic

Creature.o: Creature.cpp Creature.h Life.h Utils.h ConsumerI.h ConsumerII.h Vegetal.h
	g++ -o Creature.o -c Creature.cpp -Wall -pedantic

Vegetal.o: Vegetal.cpp Vegetal.h Life.h Utils.h
